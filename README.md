...
| Project | Description | Tools | Status |
|---|---|---|---|
| ⚙️ [GOOSE Relay-Breaker Communication](https://github.com/muhammadshahzaibshahzaib92-dev/goose-relay-breaker) | Publisher-subscriber IEDs exchanging GOOSE trip signals over the network | libiec61850, Python | 🟡 In Progress |
...
*"Bridging traditional power engineering with AI-driven grid optimization."*
